                    ...
                    <div key={item.id} className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 space-y-4 hover:border-indigo-500/20 transition-all">
                      ...
                      {item.isGrcRelevant && item.actionNeeded && (
                        <div className="space-y-2 border-t border-white/5 pt-4">
                          ...
                          <div className="flex items-start justify-between gap-4 p-3 bg-indigo-500/5 rounded-xl border border-indigo-500/10">
                            ...
                            >
                              {copiedId === item.id ? <CheckCircle2 className="h-4 w-4 text-emerald-400" /> : <Copy className="h-4 w-4" />}
                            </Button>
                          </div>
                        </div>
                      )}
