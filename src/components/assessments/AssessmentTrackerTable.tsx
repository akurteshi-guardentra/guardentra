      ...
      <td colSpan={6} className="px-4 py-14 text-center text-slate-500">
        <p className="mb-4 text-sm text-slate-400">
          {hasAnyAssessments
            ...
            : 'No assessments yet. Start with FastTrack triage to pick scope, then send the questionnaire.'}
        </p>
    ...
    <>
      <div className="flex flex-wrap items-center gap-2 border-b border-white/5 p-4">
        ...
        <span className="text-xs text-slate-500" aria-live="polite">
          Showing {filtered.length} of {assessmentsCount}
        </span>
      </div>

      <div className="max-h-[min(70vh,40rem)] overflow-auto">
        <table className="w-full text-left text-sm text-slate-200">
          <thead className="sticky top-0 z-10 border-b border-white/5 bg-slate-950">
            <tr>
                    ...
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <Link
                          ...
                          className="block truncate text-sm font-medium text-slate-100 hover:text-primary hover:underline"
                          title={a.vendorName || 'Vendor'}
                        >
                          {a.vendorName || 'Vendor'}
                        </Link>
                        <p className="text-xs text-slate-500">Linked vendor</p>
